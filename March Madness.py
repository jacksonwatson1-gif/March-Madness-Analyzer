...
with tab1:
    ...
    with col_b:
        ...
        st.bar_chart(seed_avg.set_index("Seed"), width='stretch', height=220)
        ...
        if "Continuity" in df_filtered.columns:
            ...
            st.bar_chart(cont_avg.set_index("Seed"), width='stretch', height=220)
...
with tab3:
    ...
    with mgmt_col2:
        st.markdown("<br>", unsafe_allow_html=True)
        if st.button("💾 Save Bracket", width='stretch'):
...
with tab4:
    ...
    with col_f1:
        ...
        st.bar_chart(chart_data, width='stretch', height=300)
...
with tab5:
    ...
    st.dataframe(pd.DataFrame(upset_rows), width='stretch')
...
with tab6:
    ...
    st.dataframe(notable, width='stretch')
...
with tab7:
    ...
    if run_sim:
        ...
        with col_s1:
            ...
            st.bar_chart(seed_prob.set_index("Seed"), width='stretch', height=260)
